...
: FINALIZE-X PLAYER .WORLD_X @ CAM_X @ - PLAYER .SPR X! ;
: FINALIZE-Y PLAYER .WORLD_Y @ PLAYER .SPR Y! ;

: FLIP   PLAYER .SPR PROP@ %00000010 OR  PLAYER .SPR PROP! ;
: UNFLIP PLAYER .SPR PROP@ %11111101 AND PLAYER .SPR PROP! ;
...
BEGIN
  ...
  DT @ 16 > IF   \ 60 FPS
    ...
    \ " X=" PRINT PLAYER .SPR X@ . "  Y=" PRINT PLAYER Y@ .
   ...
   \ PLAYER .SPR Y@ 8 + 224 >= IF 0 HALT THEN
    TICKS TIMER !

  THEN

  ANIM_TIMER @ TICKS - ABS 150 > IF
    PLAYER .SPR ANIMATION @ ANIMATE
    TICKS ANIM_TIMER !
  THEN

...
: TILE-W  SXI     SYI     TILE C@ >TYPE ;
: TILE-E  SXI 8 + SYI     TILE C@ >TYPE ;
: TILE-SW SXI     SYI 8 + TILE C@ >TYPE ;
: TILE-SE SXI 8 + SYI 8 + TILE C@ >TYPE ;
: TILE-NW SXI     SYI     TILE C@ >TYPE ;
: TILE-NE SXI 8 + SYI     TILE C@ >TYPE ;
...
: FINALIZE-X SXI CAM_X @ - PLAYER X! ;
: FINALIZE-Y SYI PLAYER Y! ;
...
: SCROLL
  SXI SCROLL_START_X_LEFT < IF
    SXI SCROLL_START_X_LEFT -
    0 MAX
    CAM_X !
  THEN
  SXI SCROLL_START_X_RIGHT > IF
    SXI SCROLL_START_X_RIGHT -
    0 MAX
    CAM_X !
  THEN

...
: PL_WORLD_X_SUB PLAYER ;
: PL_WORLD_Y_SUB PLAYER CELL + ;
: PL_WORLD_X PLAYER 2 CELLS + ;
: PL_WORLD_Y PLAYER 3 CELLS + ;
: VX PLAYER 6 CELLS + ;
: VY PLAYER 7 CELLS + ;
...
: AT-ENTRY? ( door -- bool )
  ...
  PL_WORLD_Y @ ROT  .ENTRY.Y PL_WORLD_Y @ 8 + BETWEEN?
  AND ;

: AT-EXIT? ( door -- bool )
  ( TODO rct )
  PL_WORLD_X @ OVER .EXIT.X PL_WORLD_X @ 8 + BETWEEN?
  PL_WORLD_Y @ ROT  .EXIT.Y PL_WORLD_Y @ 8 + BETWEEN?
  AND ;
...
: FINALIZE-X PL_WORLD_X @ CAM_X @ - PLAYER_SPR X! ;
: FINALIZE-Y PL_WORLD_Y @ PLAYER_SPR Y! ;

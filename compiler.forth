...
: >OPCODE ( s -- opcode / 0 )
  ...
  DUP " CALL"     STR= IF DROP $1A EXIT THEN
  DUP " EXIT"     STR= IF DROP $1B EXIT THEN
  DUP " EMIT"     STR= IF DROP $1C EXIT THEN
  DUP " LIT"      STR= IF DROP $1D EXIT THEN
  DUP " %"        STR= IF DROP $1E EXIT THEN
  DUP " KEY"      STR= IF DROP $1F EXIT THEN
  DUP " SP"       STR= IF DROP $20 EXIT THEN
  DUP " HALT"     STR= IF DROP $21 EXIT THEN
  DUP " LSHIFT"   STR= IF DROP $22 EXIT THEN
  DUP " RSHIFT"   STR= IF DROP $23 EXIT THEN
  DUP " !"        STR= IF DROP $24 EXIT THEN
  DUP " @"        STR= IF DROP $25 EXIT THEN
  DUP " >R"       STR= IF DROP $26 EXIT THEN
  DUP " R>"       STR= IF DROP $27 EXIT THEN
  DUP " R@"       STR= IF DROP $28 EXIT THEN
  DUP " I"        STR= IF DROP $28 EXIT THEN \ Alias to R@
  DUP " DUMP"     STR= IF DROP $29 EXIT THEN
  DUP " ABORT"    STR= IF DROP $2A EXIT THEN
  DROP 0
;

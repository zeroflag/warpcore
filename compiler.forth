...
: >OPCODE ( s -- opcode / 0 )
  ...
  DUP " HALT"     STR= IF DROP $22 EXIT THEN
  DUP " LSHIFT"   STR= IF DROP $23 EXIT THEN
  DUP " RSHIFT"   STR= IF DROP $24 EXIT THEN
  DUP " !"        STR= IF DROP $25 EXIT THEN
  DUP " C!"       STR= IF DROP $26 EXIT THEN
  DUP " @"        STR= IF DROP $27 EXIT THEN
  DUP " C@"       STR= IF DROP $28 EXIT THEN
  DUP " >R"       STR= IF DROP $29 EXIT THEN
  DUP " R>"       STR= IF DROP $2A EXIT THEN
  DUP " R@"       STR= IF DROP $2B EXIT THEN
  DUP " I"        STR= IF DROP $2B EXIT THEN \ Alias to R@
  DUP " DUMP"     STR= IF DROP $2C EXIT THEN
  DUP " ABORT"    STR= IF DROP $2D EXIT THEN
  DROP 0
;

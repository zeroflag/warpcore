...
all: clean vm stage1 stage2 test-core test-bootstrap test-compiler test-self-hosted
...
.PHONY: all clean test-core test-bootstrap test-compiler test-self-hosted stage1 stage2
